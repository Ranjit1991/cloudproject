<?php include('../functions/update_ac.php') ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="navbar ">
 ...
 <form method="post" id="update_ac">
	<p class="div_p">Update Customer's Account</p>
	...
	<div>
  	...
  	<div>
		...
		<a class="design" href="View_Account.php">View Account</a>
  	</div>
  </form>
