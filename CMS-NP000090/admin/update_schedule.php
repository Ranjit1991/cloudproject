<?php include('../functions/UpdateSchedule_Fuction.php') ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
<!-- Add Schedule -->
 ...
 <form method="post" id="update_schedule">
	<p class="div_p">Update Schedule</p>
	...
	<!-- validation -->
  	<div <?php if (isset($departure_name_error)): ?> class="form_error" <?php endif ?> >
		...
		<input type="text" name="departure_name" placeholder="Departure Name"  required><br>
  	...
  	<div <?php if (isset($arrival_name_error)): ?> class="form_error" <?php endif ?> >
		...
		<input type="text" name="arrival_name" placeholder="Arrival Name"  required><br>
	...
	<div>
  	...
  	<div>
		...
		<a class="design" href="View_Schedule.php">View Schedule</a>
  	</div>
  </form>
