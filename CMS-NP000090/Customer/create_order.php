...
<!-- Navegation Bar -->
	<div class="navbar ">
		<ul id="myDIV">
			...
			<li class="active"><a href="../Customer/create_order.php">Order Cargo</a></li>
...
<!-- Create order cargo -->
<div class="order_cargo" style="height:630px;">
<form  method="post">
	<p class="div_p">Make Order Cargo</p>
			  ...
			  if(isset($_POST['submit'])){
				...
				if(empty($_POST ['Departure_Name'])){
				  $Data_Empty[]="Depature is Empty";
				   ...
				   $Data_Empty[]="Depature should be Characters.";
				}
				else{
		...
		<input class="div_input" type="text" name="Departure_Name" placeholder="Enter Depature Name" required><br>
